...
#line 124 "binary.tab.hh" // lalr1.cc:377
  ...
  parser::symbol_type
  parser::make_SPACE (const std::string& v)
  {
    return symbol_type (token::SPACE, v);
  }
  ...
  parser::symbol_type
  parser::make_DBQ (const std::string& v)
  {
    return symbol_type (token::DBQ, v);
  }

  parser::symbol_type
  parser::make_SUBBEGIN ()
  {
    return symbol_type (token::SUBBEGIN);
  }

  parser::symbol_type
  parser::make_SUBEND ()
  {
    return symbol_type (token::SUBEND);
  }



} // yy
#line 1062 "binary.tab.hh" // lalr1.cc:377
