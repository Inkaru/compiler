...
#line 47 "binary.tab.hh" // lalr1.cc:377
...
namespace yy {
#line 124 "binary.tab.hh" // lalr1.cc:377
  ...
  parser::make_NEWL ()
  {
    return symbol_type (token::NEWL);
  }

  parser::symbol_type
  parser::make_BROPEN ()
  {
    return symbol_type (token::BROPEN);
  }

  parser::symbol_type
  parser::make_BRCLOSE ()
  {
    return symbol_type (token::BRCLOSE);
  }

  parser::symbol_type
  parser::make_ACOPEN ()
  {
    return symbol_type (token::ACOPEN);
  }

  parser::symbol_type
  parser::make_ACCLOSE ()
  {
    return symbol_type (token::ACCLOSE);
  }

  parser::symbol_type
  parser::make_SQBROPEN ()
  {
    return symbol_type (token::SQBROPEN);
  }

  parser::symbol_type
  parser::make_SQBRCLOSE ()
  {
    return symbol_type (token::SQBRCLOSE);
  }
  ...
  parser::make_STEND ()
  {
    return symbol_type (token::STEND);
  }
  ...
  parser::make_NEQU ()
  {
    return symbol_type (token::NEQU);
  }

  parser::symbol_type
  parser::make_INFEQ ()
  {
    return symbol_type (token::INFEQ);
  }

  parser::symbol_type
  parser::make_SUPEQ ()
  {
    return symbol_type (token::SUPEQ);
  }

  parser::symbol_type
  parser::make_DBEQU ()
  {
    return symbol_type (token::DBEQU);
  }
...
#line 1445 "binary.tab.hh" // lalr1.cc:377
